 ...
 var h1 = document.querySelector('.content h1');
    ...
    var info = document.querySelector(".itdev-info h1");
    ...
    function infoAndPartsAnimation(){
        ...
        gsap.to(".itdev-parts .elem:nth-child(odd)",{
            x: -100,
            stagger:0.1,
            ease: "power3.easeInOut",
            scrollTrigger:{
        ...
        gsap.to(".itdev-parts .elem:nth-child(even)",{
            x: 100,
            stagger:0.1,
            ease: "power3.easeInOut",
            scrollTrigger:{
